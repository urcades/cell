...
use cell_ai_core::{ToolDefinition, ToolResultMessage, UserContentBlock};
use cell_plugin_host::{ActivePluginRegistry, PluginContentBlock};
...
fn plugin_tool_parameters(parameters: &[cell_plugins::ParameterRegistrationV1]) -> Value {
...
fn value_kind_to_json_type(kind: &cell_plugins::ValueKindV1) -> &'static str {
    match kind {
        cell_plugins::ValueKindV1::String | cell_plugins::ValueKindV1::Path => "string",
        cell_plugins::ValueKindV1::Boolean => "boolean",
        cell_plugins::ValueKindV1::Integer => "integer",
        cell_plugins::ValueKindV1::Number => "number",
        cell_plugins::ValueKindV1::Json
        | cell_plugins::ValueKindV1::StringList
        | cell_plugins::ValueKindV1::StringMap => "object",
    }
}
...
mod tests {
    ...
    use cell_plugin_host::{DISCOVERY_FILE_NAMES, HostIdentity, PluginHost, PluginHostConfig};
    use cell_plugins::{
    ...
    fn plugin_manifest_json(id: &str, name: &str, tool_name: &str) -> String {
        ...
        manifest.models.push(cell_plugins::ModelRegistrationV1 {
            provider_id: id.to_string(),
...
"#
    ...
    fn write_plugin_descriptor(root: &Path, id: &str, name: &str) {
        ...
        let descriptor = cell_plugin_host::PluginLaunchDescriptor {
            id: id.to_string(),
            name: name.to_string(),
