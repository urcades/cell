...
fn render_tool_result(
    target: &mut Vec<RenderedLine>,
    result: &cell_ai_core::ToolResultMessage,
    args: Option<&Value>,
    width: usize,
    show_images: bool,
    terminal_capabilities: &TerminalCapabilities,
...
fn tool_notice_lines(result: &cell_ai_core::ToolResultMessage) -> Vec<String> {
...
fn append_image_block(
    ...
    if show_images && terminal_capabilities.inline_images {
        target.push(RenderedLine::Image(cell_tui::ImageLine {
...
fn tool_result_panel_id(result: &cell_ai_core::ToolResultMessage) -> String {
