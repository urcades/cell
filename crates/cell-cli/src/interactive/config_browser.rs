use super::*;
use cell_packages::PackageInstallScope;
...
impl ConfigResourceKind {
    ...
    fn resource_kind(self) -> cell_resources::ResourceKind {
        match self {
            Self::Skill => cell_resources::ResourceKind::Skills,
            Self::Prompt => cell_resources::ResourceKind::Prompts,
            Self::Theme => cell_resources::ResourceKind::Themes,
        }
    }

    fn package_resource_kind(self) -> cell_packages::PackageResourceKind {
        match self {
            Self::Skill => cell_packages::PackageResourceKind::Skills,
            Self::Prompt => cell_packages::PackageResourceKind::Prompts,
            Self::Theme => cell_packages::PackageResourceKind::Themes,
        }
    }
}
...
fn toggle_top_level_resource(
    ...
    cell_resources::toggle_scoped_resource_entry(
    ...
    fn toggling_disabled_package_resource_persists_exact_reenable() {
        ...
        manager
            .set_package_filters(
                &installed.identity,
                PackageInstallScope::Project,
                cell_packages::PackageResourceKind::Skills,
