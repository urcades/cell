...
use pi_rust_ai_core::{AssistantContentBlock, Message, UserContent, UserContentBlock};
...
struct RenderPageInput<'a> {
    header: &'a pi_rust_session::SessionHeader,
    session_name: &'a str,
...
fn render_user_message(
    index: usize,
    user: &pi_rust_ai_core::UserMessage,
    preview: &str,
    search_text: &str,
) -> String {
...
fn render_tool_result_message(
    index: usize,
    tool_result: &pi_rust_ai_core::ToolResultMessage,
    preview: &str,
    search_text: &str,
) -> String {
...
fn render_tool_result_content(tool_result: &pi_rust_ai_core::ToolResultMessage) -> String {
...
fn build_jsonl_lines(header: &pi_rust_session::SessionHeader, messages: &[Message]) -> Vec<String> {
        ...
        session
            .append_message(Message::User(UserMessage {
                content: UserContent::Blocks(vec![
                    pi_rust_ai_core::UserContentBlock::Text {
            ...
            .expect("user");
        session
            .append_message(Message::ToolResult(pi_rust_ai_core::ToolResultMessage {
