...
use pi_rust_config::{SettingsLoadError, SettingsManager, SettingsScope};
use pi_rust_models::{
...
impl AgentSession {
    ...
    pub fn get_session_stats(&self) -> RpcSessionStats {
        ...
        let mut usage = Usage {
            ...
            cache_write: 0,
            total_tokens: 0,
            cost: pi_rust_ai_core::UsageCost {
                input: "0".to_string(),
                output: "0".to_string(),
...
fn format_bash_execution_text(
    command: &str,
    result: &pi_rust_tools::BashExecutionResult,
) -> String {
...
fn location_for_scope(scope: pi_rust_resources::ResourceScope) -> RpcCommandLocation {
    match scope {
        pi_rust_resources::ResourceScope::Global => RpcCommandLocation::User,
        pi_rust_resources::ResourceScope::Project => RpcCommandLocation::Project,
    }
}
