...
use cell_ai_core::{ApiId, Model, ModelCost, ModelInput, ProviderId};
use cell_config::get_models_path;
use cell_oauth::{AuthSource, AuthStorage, resolve_config_value, resolve_headers};
...
mod tests {
    ...
    use cell_oauth::{AuthCredential, AuthSource, AuthStorage, OAuthCredentials};
